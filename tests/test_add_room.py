...
class AddRoomTests(TestCase):
    ...
    def test_create_office(self):
        ...
        self.assertTrue(blue_office, "Office has not been created")

        new_office_count = len(dojo.office_dict)
        self.assertEqual(
            new_office_count - initial_office_count, 
            1, 
            "Only a single office object should have been added to the office dictionary"
            )
    ...
    def test_create_living_space(self):
        ...
        self.assertTrue(blue_living_space, "Living Space has not been created")
    
        new_living_space_count = len(dojo.living_space_dict)
        self.assertEqual(
            new_living_space_count - initial_living_space_count, 
            1, 
            "Only a single living space object should have been added to the living space dictionary"
            )
